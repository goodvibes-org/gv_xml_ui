...
EDU_DF_PATH = "scores_edu_sin_correccion.csv"
...
df.to_csv("comparacion_sin_corr.csv")

fig, ax = plt.subplots(nrows = 1, ncols = 3, figsize = (40, 10))
join.to_csv("datos_todos_sin_corr.csv")
...
plt.savefig("sin_correccion_puntajes.png")
plt.show()
